...
print(counter != 0 ? "\(arrayToCheck) შეიცავს მსგავს ელემენტებს" : "\(arrayToCheck) array-ში ყველა ელემენტი განსხვავებულია")
...
var resultsixth = sixth(fNum, sNum)
print("\(fNum) - \(sNum) = \(resultsixth)")
